...
6.  Under **Additional Statistics**, select `Mean difference`, `Effect size`, and `Descriptives`. You may also select `Descriptives plots`, although [Chapter 6](06.0-visualizing-data-in-jamovi.qmd) provides better options for creating graphs
...
> A Mann-Whitney U test indicated that grades differed significantly between students taught by Anastasia (*Mdn* = 76, *n* = 15) and students taught by Bernadette (*Mdn* = 69, *n* = 18), *U* = 79.50, *p* = .046, (r\_{pb} = .41).
