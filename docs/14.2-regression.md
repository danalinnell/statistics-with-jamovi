...
![(\#fig:unnamed-chunk-1)Regression lines and residuals](images/13-regression/dragon_categorical.png){width=49%}![(\#fig:unnamed-chunk-1)Regression lines and residuals](images/13-regression/dragons_continuous.png){width=49%}
...
![(\#fig:unnamed-chunk-2)Regression lines and residuals](images/13-regression/good-regression-line.jpg){width=49%}![(\#fig:unnamed-chunk-2)Regression lines and residuals](images/13-regression/bad-regression-line.jpg){width=49%}
...
![(\#fig:unnamed-chunk-3)Regression lines and residuals](images/13-regression/dragon_predict_mlr.png){width=49%}![(\#fig:unnamed-chunk-3)Regression lines and residuals](images/13-regression/dragon_residual.png){width=49%}
...
![(\#fig:unnamed-chunk-4)Regression lines and residuals](images/13-regression/dragon_residual_distribution.png){width=49%}
