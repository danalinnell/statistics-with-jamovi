...
![(\#fig:unnamed-chunk-1)One-way ANOVA as a regression](images/14-regression-wrap-up/anova1.png){width=49%}![(\#fig:unnamed-chunk-1)One-way ANOVA as a regression](images/14-regression-wrap-up/anova2.png){width=49%}
