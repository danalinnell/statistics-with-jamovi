...
This connects directly to [Chapter 2: Statistics Foundations](02.0-statistics-foundations.qmd). A variable may be coded with numbers, such as 0 = no and 1 = yes, but that does not make it continuous. You still need to set the measure type based on what the variable represents.
