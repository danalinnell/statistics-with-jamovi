...
Post hoc comparisons are used after a significant omnibus ANOVA when we want to compare the groups pair by pair. We will continue using the clinical trial example from @sec-one-way-anova, where participants were assigned to one of three drug conditions: placebo, anxifree, or joyzepam.
