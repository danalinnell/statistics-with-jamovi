...
-   Use the sidebar or table of contents to jump between chapters and sections.
-   Use the search feature when you are trying to find a specific term, test, or *jamovi* step.
-   Use the previous and next buttons when you are working through chapters in order.
